...
M10 is the current **working Harbour and cabin craft candidate**, based on merged M9 (`62fd098`). It expands Harbour with a monumental drydock arch, elevated concourse, terraced habitats, persistent distant windows, illuminated berth interiors and six traffic routes. It removes duplicated floating engine spheres, restores dust-free First Question stars with optional forward cruise, and refines the room with bound books, soft cushions, material texture and a compact personal computer. Proposed version: `2.0.0-m10-working-harbour` (`20016`). See the [OpenClaw build and review guide](docs/development/working-harbour-review.md). **Unity compilation, regeneration, bake, 81 captures, APK and headset visual/comfort/performance validation remain pending.**
