...
M9 is the current **five-vista visual overhaul candidate**: a new galactic panorama, geometric station/ship lighting, close orbital clouds and aurora, a giant anticyclone and companion moon, and a much larger broadside flagship. Proposed version: `2.0.0-m9-five-vista-overhaul` (`20015`). See the [implementation and OpenClaw review guide](docs/development/five-vista-overhaul-review.md). **Unity compilation, bake, 62 captures, APK, in-headset visual/stereo and sustained performance/thermal acceptance remain pending for this candidate.** Previous M8 validation is recorded in its [review guide](docs/development/harbour-depth-review.md).
